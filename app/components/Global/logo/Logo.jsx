  ...
  return (
    <div className="logo">
      <svg width="32" height="32" viewBox="0 0 80 80">
		...
		C20.68,3.58,9.7,20.12,9.7,40c0,20.99,11.68,36.42,30.44,36.42c16.18,0,26.24-10.52,29.88-24.33c0.46-1.75-0.9-3.4-2.72-3.39
		C67.28,48.7,67.27,48.7,67.25,48.7z"
          />
        </g>
        <path
          className={styles.design}
